      ...
      <header className="sticky top-0 z-50 bg-white/70 dark:bg-[#09090B]/70 backdrop-blur-xl border-b border-gray-200/80 dark:border-gray-800/80 transition-colors">
        <div className="max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3 relative z-10">
            <img src="/logo.svg" alt="Data Quality Analyzer Logo" className="w-9 h-9 rounded-full shadow-sm object-cover bg-white" onError={(e) => { e.currentTarget.src = '/favicon.svg'; }} />
